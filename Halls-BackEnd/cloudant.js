...
fixed_algorithims(1, 8, 9, 50, 50, 46, 9, 100);
// if (caseNo == 2) {
//     //if the gap is 100cm or bigger so we can distrubute each part in the hall as punch 
//     let noGroups = columns / columnsThenGap;
//     if (gapwidth >= 100) {
...
//         let start =1
//         while (c < noGroups) {
//           count=  algorithm(rows ,columnsThenGap,chairLength,chairWidth,c,start,count);
//             c++;
//         }
//         console.log(output);
//         return output;
...
//         let count = 0;
//         while (c < noGroups) {
//             count=  algorithm(rows ,columnsThenGap,chairLength,chairWidth,c,startPosition[c],count);
//             c++;
//         }
//     }
//     console.log(output);
